...
class _VideoAppState extends State<VideoApp> {
  ...
  void initState() {
    ...
    videoUrl = 'https://github.com/cherrytank/stroke_rehabilitation_app/raw/main/assets/pose_videos/${_posenumber}.mp4';
    // Fallback for specific numbers if the pattern doesn't hold (example)
    if (_posenumber == 0) { // Example: if video 0 is named differently or has a specific URL
        videoUrl = 'https://raw.githubusercontent.com/cherrytank/stroke_rehabilitation_app/main/assets/pose_videos/0.mp4';
    }
  ...
  Widget build(BuildContext context) {
    ...
    final appBarButtonSize = isLandscape ? screenSize.height * 0.08 : screenSize.width * 0.1; // For potential AppBar elements
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("動作示範", style: TextStyle(color: Colors.white, fontSize: isLandscape ? screenSize.height * 0.05 : screenSize.width * 0.055)),
        centerTitle: true,
      ),
      body:Container(
        color: Color.fromARGB(255, 144, 189, 249),
        padding: EdgeInsets.all(isLandscape ? screenSize.width * 0.025 : 16.0), // Adjusted padding
        child: bodyContent,
      ),
    );
  }
